...
from solutions.torch_modules import SelfAttentionMatrix, CMIAttentionMatrixForCarRacing, CMIAttentionMatrixForAcrobot, CMIAttentionMatrixForMountainCar, CMIAttentionMatrixForCartPole, CMIAttentionMatrixForPyAnt
from solutions.torch_modules import AttentionNeuronLayer, CMIAttentionNeuronLayerForAcrobot, CMIAttentionNeuronLayerForCartPole, CMIAttentionNeuronLayerForMountainCar, CMIAttentionNeuronLayerForPyAnt 
...
@gin.configurable
class CMIPIFCSolutionForCartPole(BaseTorchSolution):
    """CMI Permutation invariant solution For CartPole."""
    ...
    def __init__(self,
                 ...
                 pi_layer_bias=True,
                 pi_layer_scale=True):
        super(CMIPIFCSolutionForCartPole, self).__init__(device=device)
        ...
        self.pi_layer = CMIAttentionNeuronLayerForCartPole(
            act_dim=act_dim,
...
@gin.configurable
class CMIPIFCSolutionForAcrobot(BaseTorchSolution):
    """CMI Permutation invariant solution For Acrobot."""
    ...
    def __init__(self,
                 ...
                 pi_layer_bias=True,
                 pi_layer_scale=True):
        super(CMIPIFCSolutionForAcrobot, self).__init__(device=device)
        self.act_dim = act_dim
        self.hidden_dim = hidden_dim
        self.msg_dim = msg_dim
        self.pos_em_dim = pos_em_dim
        ...
        self.pi_layer = CMIAttentionNeuronLayerForAcrobot(
            act_dim=act_dim,
            hidden_dim=hidden_dim,
            msg_dim=msg_dim,
            pos_em_dim=pos_em_dim,
    ...
    def _get_action(self, obs):
        ...
        x = self.net(x.T)
        x = self.linear(x)
        distCat = torch.distributions.Categorical(probs=torch.nn.functional.softmax(x))
        action = distCat.sample().item()
        
        # Acrobot is a discrete env so we need Categorical Dist, with sampling

        self.prev_act = torch.tensor(action)
...
@gin.configurable
class CMIPIFCSolutionForMountainCar(BaseTorchSolution):
    """CMI Permutation invariant solution For Mountain Car."""
    ...
    def __init__(self,
                 ...
                 pi_layer_bias=True,
                 pi_layer_scale=True):
        super(CMIPIFCSolutionForMountainCar, self).__init__(device=device)
        self.act_dim = act_dim
        self.hidden_dim = hidden_dim
        self.msg_dim = msg_dim
        self.pos_em_dim = pos_em_dim
        ...
        self.pi_layer = CMIAttentionNeuronLayerForMountainCar(
            act_dim=act_dim,
            hidden_dim=hidden_dim,
            msg_dim=msg_dim,
            pos_em_dim=pos_em_dim,
...
@gin.configurable
class CMIPIFCSolutionForPyAnt(BaseTorchSolution):
    """CMI Permutation invariant solution For PyAnt."""
    ...
    def __init__(self,
                 ...
                 pi_layer_bias=True,
                 pi_layer_scale=True):
        super(CMIPIFCSolutionForPyAnt, self).__init__(device=device)
        self.act_dim = act_dim
        self.hidden_dim = hidden_dim
        self.msg_dim = msg_dim
        self.pos_em_dim = pos_em_dim
        ...
        self.pi_layer = CMIAttentionNeuronLayerForPyAnt(
            act_dim=act_dim,
            hidden_dim=hidden_dim,
            msg_dim=msg_dim,
            pos_em_dim=pos_em_dim,
...
@gin.configurable
class PIFCSolutionForAcrobot(BaseTorchSolution):
    """Permutation invariant solution For Acrobot."""
    ...
    def __init__(self,
                 ...
                 pi_layer_bias=True,
                 pi_layer_scale=True):
        super(PIFCSolutionForAcrobot, self).__init__(device=device)
        self.act_dim = act_dim
        self.hidden_dim = hidden_dim
        self.msg_dim = msg_dim
        self.pos_em_dim = pos_em_dim
